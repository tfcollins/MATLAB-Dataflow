# MATLAB-Dataflow [![Build Status](https://travis-ci.org/travisfcollins/MATLAB-Dataflow.svg?branch=benchmarking)](https://travis-ci.org/travisfcollins/MATLAB-Dataflow)  
